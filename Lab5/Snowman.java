...
public class Snowman extends JFrame{
  ...
  public void paint (Graphics page)
  {
    ...
    page.drawArc (MID - 10, TOP + 8 , 7, 8, 10,120); // left eyebrow
    page.drawArc (MID + 3, TOP + 8, 7, 8, 50, 120); // right eyebrow 
    ...
    page.drawString ("Ben", 0,34); //name
    
    page.setColor (Color.red);
    page.fillOval (MID - 5,TOP + 45, 10,10); //top button
    page.fillOval (MID - 5,TOP + 60, 10,10); //bottom button
